...
// SetSecurityOptions configures sandboxing permissions for subprocess and network operations.
...
// CheckSubprocessAllowed validates if subprocess execution is permitted.
...
// CheckNetworkAllowed validates if socket/network operations are permitted.
...
// initPathlibModule creates the pathlib standard library module.
func initPathlibModule() *vm.ModuleObject {
    ...
    pathClass.Methods["exists"] = &vm.BuiltinFunction{
        Name: "exists",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: exists() requires self") }
    ...
    pathClass.Methods["is_file"] = &vm.BuiltinFunction{
        Name: "is_file",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: is_file() requires self") }
            inst, _ := args[0].(*vm.InstanceObject)
            p := string(inst.Fields["_path"].(vm.StringValue))
            fi, err := os.Stat(p)
            if err != nil { return vm.BoolValue(false), nil }
    ...
    pathClass.Methods["is_dir"] = &vm.BuiltinFunction{
        Name: "is_dir",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: is_dir() requires self") }
            inst, _ := args[0].(*vm.InstanceObject)
            p := string(inst.Fields["_path"].(vm.StringValue))
            fi, err := os.Stat(p)
            if err != nil { return vm.BoolValue(false), nil }
    ...
    pathClass.Methods["read_text"] = &vm.BuiltinFunction{
        Name: "read_text",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: read_text() requires self") }
            inst, _ := args[0].(*vm.InstanceObject)
            p := string(inst.Fields["_path"].(vm.StringValue))
            content, err := os.ReadFile(p)
            if err != nil { return nil, fmt.Errorf("OSError: %v", err) }
    ...
    pathClass.Methods["write_text"] = &vm.BuiltinFunction{
        Name: "write_text",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 2 { return nil, fmt.Errorf("TypeError: write_text() requires content") }
            inst, _ := args[0].(*vm.InstanceObject)
            p := string(inst.Fields["_path"].(vm.StringValue))
            text := ""
            if sv, ok := args[1].(vm.StringValue); ok { text = string(sv) } else { text = args[1].Inspect() }
    ...
    pathClass.Methods["name"] = &vm.BuiltinFunction{
        Name: "name",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: name() requires self") }
            inst, _ := args[0].(*vm.InstanceObject)
            p := string(inst.Fields["_path"].(vm.StringValue))
    ...
    pathClass.Methods["parent"] = &vm.BuiltinFunction{
        Name: "parent",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: parent() requires self") }
            inst, _ := args[0].(*vm.InstanceObject)
            p := string(inst.Fields["_path"].(vm.StringValue))
            par := filepath.Dir(p)
    ...
    pathClass.Methods["joinpath"] = &vm.BuiltinFunction{
        Name: "joinpath",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 2 { return nil, fmt.Errorf("TypeError: joinpath() requires segment") }
            inst, _ := args[0].(*vm.InstanceObject)
            p := string(inst.Fields["_path"].(vm.StringValue))
            var parts []string
...
// initDatetimeModule creates the datetime standard library module.
func initDatetimeModule() *vm.ModuleObject {
    ...
    timedeltaClass.Methods["__init__"] = &vm.BuiltinFunction{
        Name: "__init__",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: timedelta.__init__() requires self") }
            inst, _ := args[0].(*vm.InstanceObject)
            var days, seconds, microseconds, milliseconds, minutes, hours, weeks int64
            if len(args) > 1 { days, _ = vm.ToInt(args[1]) }
            if len(args) > 2 { seconds, _ = vm.ToInt(args[2]) }
            if len(args) > 3 { microseconds, _ = vm.ToInt(args[3]) }
            if len(args) > 4 { milliseconds, _ = vm.ToInt(args[4]) }
            if len(args) > 5 { minutes, _ = vm.ToInt(args[5]) }
            if len(args) > 6 { hours, _ = vm.ToInt(args[6]) }
            if len(args) > 7 { weeks, _ = vm.ToInt(args[7]) }
    ...
    datetimeClass.Methods["__init__"] = &vm.BuiltinFunction{
        Name: "__init__",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 4 { return nil, fmt.Errorf("TypeError: datetime() takes at least year, month, day") }
            inst, _ := args[0].(*vm.InstanceObject)
            y, _ := vm.ToInt(args[1]); mo, _ := vm.ToInt(args[2]); d, _ := vm.ToInt(args[3])
            var h, mi, s, us int64
            if len(args) > 4 { h, _ = vm.ToInt(args[4]) }
            if len(args) > 5 { mi, _ = vm.ToInt(args[5]) }
            if len(args) > 6 { s, _ = vm.ToInt(args[6]) }
            if len(args) > 7 { us, _ = vm.ToInt(args[7]) }
    ...
    datetimeClass.Methods["strftime"] = &vm.BuiltinFunction{
        Name: "strftime",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 2 { return nil, fmt.Errorf("TypeError: strftime() requires format") }
            inst, _ := args[0].(*vm.InstanceObject)
            nano, _ := vm.ToInt(inst.Fields["_t"])
            t := time.Unix(0, nano)
            fmtStr := "%Y-%m-%d %H:%M:%S"
            if sv, ok := args[1].(vm.StringValue); ok { fmtStr = string(sv) }
            // Map common python strftime formats to Go time layout
            goFmt := fmtStr
    ...
    datetimeClass.Methods["isoformat"] = &vm.BuiltinFunction{
        Name: "isoformat",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: isoformat() requires self") }
            inst, _ := args[0].(*vm.InstanceObject)
            nano, _ := vm.ToInt(inst.Fields["_t"])
            t := time.Unix(0, nano)
...
// initCollectionsModule creates the collections module (deque, Counter, defaultdict, OrderedDict, namedtuple).
func initCollectionsModule() *vm.ModuleObject {
    ...
    counterClass.Methods["__init__"] = &vm.BuiltinFunction{
        Name: "__init__",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: Counter.__init__() requires self") }
            inst, _ := args[0].(*vm.InstanceObject)
            counts := vm.NewDict()
            if len(args) > 1 {
                for _, item := range vm.ExtractIterable(args[1]) {
                    cur, _ := counts.Get(item)
                    if cur == nil { cur = vm.IntValue(0) }
    ...
    counterClass.Methods["most_common"] = &vm.BuiltinFunction{
        Name: "most_common",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: most_common() requires self") }
            inst, _ := args[0].(*vm.InstanceObject)
    ...
    dequeClass.Methods["__init__"] = &vm.BuiltinFunction{
        Name: "__init__",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: deque.__init__() requires self") }
            inst, _ := args[0].(*vm.InstanceObject)
            items := []vm.Value{}
            if len(args) > 1 {
    ...
    dequeClass.Methods["append"] = &vm.BuiltinFunction{
        Name: "append",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 2 { return nil, fmt.Errorf("TypeError: append() requires item") }
            inst, _ := args[0].(*vm.InstanceObject)
    ...
    dequeClass.Methods["appendleft"] = &vm.BuiltinFunction{
        Name: "appendleft",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 2 { return nil, fmt.Errorf("TypeError: appendleft() requires item") }
            inst, _ := args[0].(*vm.InstanceObject)
            l, _ := inst.Fields["_items"].(*vm.ListObject)
    ...
    dequeClass.Methods["pop"] = &vm.BuiltinFunction{
        Name: "pop",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: pop() requires self") }
            inst, _ := args[0].(*vm.InstanceObject)
            l, _ := inst.Fields["_items"].(*vm.ListObject)
            if len(l.Elements) == 0 { return nil, fmt.Errorf("IndexError: pop from an empty deque") }
    ...
    dequeClass.Methods["popleft"] = &vm.BuiltinFunction{
        Name: "popleft",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: popleft() requires self") }
            inst, _ := args[0].(*vm.InstanceObject)
            l, _ := inst.Fields["_items"].(*vm.ListObject)
            if len(l.Elements) == 0 { return nil, fmt.Errorf("IndexError: pop from an empty deque") }
            first := l.Elements[0]
    ...
    defaultdictClass.Methods["__init__"] = &vm.BuiltinFunction{
        Name: "__init__",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 2 { return nil, fmt.Errorf("TypeError: defaultdict() requires default_factory") }
            inst, _ := args[0].(*vm.InstanceObject)
...
// initItertoolsModule creates the itertools module.
func initItertoolsModule() *vm.ModuleObject {
    ...
    m.Exports["repeat"] = &vm.BuiltinFunction{
        Name: "repeat",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: repeat() requires item") }
            times := int64(1000)
            if len(args) > 1 { times, _ = vm.ToInt(args[1]) }
            items := make([]vm.Value, times)
            for i := int64(0); i < times; i++ { items[i] = args[0] }
    ...
    m.Exports["islice"] = &vm.BuiltinFunction{
        Name: "islice",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 2 { return nil, fmt.Errorf("TypeError: islice() requires iterable, stop") }
            ...
            if start < 0 { start = 0 }
            if stop > int64(len(items)) { stop = int64(len(items)) }
            if start >= stop { return &vm.IteratorObject{Items: []vm.Value{}, Index: 0}, nil }
    ...
    m.Exports["count"] = &vm.BuiltinFunction{
        ...
        Fn: func(args ...vm.Value) (vm.Value, error) {
            start := int64(0)
            step := int64(1)
            if len(args) > 0 { start, _ = vm.ToInt(args[0]) }
            if len(args) > 1 { step, _ = vm.ToInt(args[1]) }
...
// initFunctoolsModule creates the functools module.
func initFunctoolsModule() *vm.ModuleObject {
    ...
    m.Exports["reduce"] = &vm.BuiltinFunction{
        Name: "reduce",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 2 { return nil, fmt.Errorf("TypeError: reduce() requires function and sequence") }
        ...
        Fn: func(args ...vm.Value) (vm.Value, error) {
            return &vm.BuiltinFunction{
                ...
                Fn: func(innerArgs ...vm.Value) (vm.Value, error) {
                    if len(innerArgs) > 0 { return innerArgs[0], nil }
                    return vm.None, nil
                },
            }, nil
        },
...
// initSubprocessModule creates the subprocess module.
func initSubprocessModule() *vm.ModuleObject {
    ...
    m.Exports["run"] = &vm.BuiltinFunction{
        Name: "run",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if err := CheckSubprocessAllowed(); err != nil { return nil, err }
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: run() requires command") }
            var cmdArgs []string
            ...
            if len(cmdArgs) == 0 { return nil, fmt.Errorf("ValueError: empty command") }
    ...
    m.Exports["check_output"] = &vm.BuiltinFunction{
        ...
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if err := CheckSubprocessAllowed(); err != nil { return nil, err }
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: check_output() requires command") }
            var cmdArgs []string
            if l, ok := args[0].(*vm.ListObject); ok {
                for _, el := range l.Elements {
                    if sv, ok := el.(vm.StringValue); ok {
            ...
            cmd := exec.Command(cmdArgs[0], cmdArgs[1:]...)
            out, err := cmd.Output()
            if err != nil { return nil, fmt.Errorf("CalledProcessError: %v", err) }
...
// initSocketModule creates the socket module.
func initSocketModule() *vm.ModuleObject {
    ...
    m.Exports["gethostname"] = &vm.BuiltinFunction{
        Name: "gethostname",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if err := CheckNetworkAllowed(); err != nil { return nil, err }
            h, err := os.Hostname()
            if err != nil { return vm.StringValue("localhost"), nil }
    ...
    m.Exports["gethostbyname"] = &vm.BuiltinFunction{
        ...
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if err := CheckNetworkAllowed(); err != nil { return nil, err }
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: gethostbyname() requires host") }
            host := "localhost"
            if sv, ok := args[0].(vm.StringValue); ok { host = string(sv) }
            ips, err := net.LookupHost(host)
            if err != nil || len(ips) == 0 { return vm.StringValue("127.0.0.1"), nil }
...
// initCSVModule creates the csv module.
func initCSVModule() *vm.ModuleObject {
    ...
    m.Exports["reader"] = &vm.BuiltinFunction{
        Name: "reader",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: reader() requires iterable") }
            lines := []string{}
            ...
            if err != nil { return nil, fmt.Errorf("CSVError: %v", err) }
            var rows []vm.Value
            for _, rec := range records {
                var cols []vm.Value
                for _, c := range rec { cols = append(cols, vm.StringValue(c)) }
        ...
        Fn: func(args ...vm.Value) (vm.Value, error) {
            ...
            writerClass.Methods["writerow"] = &vm.BuiltinFunction{
                ...
                Fn: func(wArgs ...vm.Value) (vm.Value, error) {
                    if len(wArgs) < 2 { return nil, fmt.Errorf("TypeError: writerow() requires row") }
                    var row []string
                    for _, item := range vm.ExtractIterable(wArgs[1]) {
                        if sv, ok := item.(vm.StringValue); ok { row = append(row, string(sv)) } else { row = append(row, item.Inspect()) }
                    }
                    cw.Write(row)
                    cw.Flush()
                    return vm.None, nil
...
// initXMLModule creates the xml module.
func initXMLModule() *vm.ModuleObject {
    ...
    m.Exports["fromstring"] = &vm.BuiltinFunction{
        Name: "fromstring",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: fromstring() requires xml text") }
            xmlStr := ""
            if sv, ok := args[0].(vm.StringValue); ok { xmlStr = string(sv) } else { xmlStr = args[0].Inspect() }
...
// initArgparseModule creates the argparse module.
func initArgparseModule() *vm.ModuleObject {
    ...
    parserClass.Methods["__init__"] = &vm.BuiltinFunction{
        Name: "__init__",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: ArgumentParser requires self") }
            inst, _ := args[0].(*vm.InstanceObject)
            inst.Fields["description"] = vm.StringValue("")
            if len(args) > 1 { inst.Fields["description"] = args[1] }
    ...
    parserClass.Methods["add_argument"] = &vm.BuiltinFunction{
        Name: "add_argument",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 2 { return nil, fmt.Errorf("TypeError: add_argument() requires flag") }
            inst, _ := args[0].(*vm.InstanceObject)
...
// initLoggingModule creates the logging module.
    ...
    logFn := func(prefix string) *vm.BuiltinFunction {
        return &vm.BuiltinFunction{
            ...
            Fn: func(args ...vm.Value) (vm.Value, error) {
                var msgParts []string
                for _, a := range args {
                    if sv, ok := a.(vm.StringValue); ok { msgParts = append(msgParts, string(sv)) } else { msgParts = append(msgParts, a.Inspect()) }
                }
...
// initUnittestModule creates the unittest module.
func initUnittestModule() *vm.ModuleObject {
    ...
    testCaseClass.Methods["assertEqual"] = &vm.BuiltinFunction{
        Name: "assertEqual",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 3 { return nil, fmt.Errorf("TypeError: assertEqual() requires a and b") }
    ...
    testCaseClass.Methods["assertTrue"] = &vm.BuiltinFunction{
        Name: "assertTrue",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 2 { return nil, fmt.Errorf("TypeError: assertTrue() requires expr") }
            if !args[1].Truthy() {
    ...
    testCaseClass.Methods["assertFalse"] = &vm.BuiltinFunction{
        Name: "assertFalse",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 2 { return nil, fmt.Errorf("TypeError: assertFalse() requires expr") }
            if args[1].Truthy() {
...
// initCProfileModule creates the cProfile profiler module.
...
// initWeakRefModule creates the weakref module.
func initWeakRefModule() *vm.ModuleObject {
    m := vm.NewModule("weakref")
    m.Exports["ref"] = &vm.BuiltinFunction{
        Name: "ref",
        Fn: func(args ...vm.Value) (vm.Value, error) {
            if len(args) < 1 { return nil, fmt.Errorf("TypeError: ref() requires referent") }
